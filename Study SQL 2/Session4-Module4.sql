...
** File: Session4-Module4.sql
** Desc: String, Numeric, Date functions
...
# LPAD - pads leading spaces / RPAD - pads trailing spaces
SELECT
	customerNumber,
...
#    DATEDIFF ('06-03-2016' AS DATE , '06-03-2014' AS DATE) AS numberOfDays
FROM
    orders
