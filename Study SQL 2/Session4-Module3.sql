...
** File: Session4-Module3.sql
** Desc: Views and Indexes
...
# Exercise : Show the top 50 orders by basketValue 
...
# Exercise : Select data from the view
...
# Exercise : select data from underlying table
SELECT
    officeCode, phone, city
FROM
    *
...
ALTER TABLE customers DROP INDEX cityState_Index;
