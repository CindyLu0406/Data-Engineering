...
import com.datastax.dse.demos.solr.load.CQLLoadStrategy;
import com.datastax.dse.demos.solr.load.InputLoader;
import com.datastax.dse.demos.solr.load.LoadStrategy;
...
public class LoadCmdRunner extends CmdRunner
{
    ...
    private void runCommandImpl(List<String> cmd2Run) throws Throwable
    {
        ...
        {
            inputReaderClassName = "com.datastax.dse.demos.solr.load.GeonamesLoader";
        }
