...
import com.datastax.bdp.search.solr.metrics.IndexReaderMetricsMXBean;
import com.datastax.bdp.search.solr.metrics.UpdateMetrics.UpdatePhase;
import com.datastax.bdp.search.solr.metrics.UpdateMetricsMXBean;
...
public class JMXMetrics
{
    ...
    public JMXMetrics(CommandLine.Params params) throws Exception
    {
        ...
        ObjectName updateMetricsObjectName = ObjectName.getInstance("com.datastax.bdp:type=search,index=" + params.indexName + ",name=UpdateMetrics");
        updateMetrics = JMX.newMXBeanProxy(connection, updateMetricsObjectName, UpdateMetricsMXBean.class);
        ObjectName indexSearcherMetricsObjectName = ObjectName.getInstance("com.datastax.bdp:type=search,index=" + params.indexName + ",name=IndexReaderMetrics");
