...
Before starting this demo, be sure that you have started DataStax Enterprise with Solr enabled on one or more nodes. See "Starting DSE and DSE Search" in the DataStax documentation (http://docs.datastax.com/en/datastax_enterprise/latest/datastax_enterprise/srch/srchInstall.html).
