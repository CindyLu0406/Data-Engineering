...
java $JVM_OPTS $DSE_OPTS -Dlogback.configurationFile=logback-tools.xml $JAVA_AGENT -ea -Xmx1G -Xms256M -cp "$CLASSPATH" com.datastax.dse.demos.solr.Wikipedia --host $HOST --port $NATIVEPORT --wikifile $WIKIFILE $LIMIT $USER $PASS
